...
export default function DispatchOnInvoice() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-black text-slate-800">DispatchOnInvoice</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center">
        <div className="max-w-md mx-auto">
          ...
          <h3 className="text-lg font-bold text-slate-800 mb-2">DispatchOnInvoice Page</h3>
